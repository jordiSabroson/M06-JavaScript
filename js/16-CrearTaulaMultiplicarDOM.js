 ...
 * Després omplir les caselles amb el número anterior multiplicat o algo així
 */
...
function taulaMultiplicar() {
    ...
    for (let i = 1; i <= files; i++) {
        ...
        for (let a = 1; a <= columnes; a++) {
            // Variable que crea les cel·les de la taula junt amb el text que omplirà la cel·la (en aquest cas els números multiplicats)
            let cell = document.createElement("td");
            let cellText = document.createTextNode(i*a);
